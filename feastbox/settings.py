# Django settings for feastbox project.
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        #'URL': 'http://54.221.230.85:8983/solr' 
		'URL': 'http://127.0.0.1:8983/solr'
    },
}


CKEDITOR_UPLOAD_PATH = '/opt/bitnami/apps/django/django_projects/feastbox/media/ckeditor'
...
MEDIA_ROOT = '/opt/bitnami/apps/django/django_projects/feastbox/media'
...
STATIC_ROOT = '/opt/bitnami/apps/django/django_projects/feastbox/static'
...
STATICFILES_DIRS = (
    ...
    #'/opt/bitnami/apps/django/django_projects/feastbox/static',
)
...
SECRET_KEY = '*1zeb)v3(s74#wwin*by9!i%612u3!7v(krbi6qdckw4lw+4(#'
...
ROOT_URLCONF = 'feastbox.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'feastbox.wsgi.application'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/opt/bitnami/apps/django/django_projects/feastbox/templates',
)
